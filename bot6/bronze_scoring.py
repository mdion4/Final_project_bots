...
def build_rocketsim_env():
    ...
    reward_fn = CombinedReward.from_zipped(
        ...
        (EventReward(team_goal=goal_reward, concede=concede_reward), 20), # put the ball in the net dummy
        ...
        (VelocityBallToGoalAlignedReward(), 5),
...
if __name__ == "__main__":
    ...
    learner = Learner(build_rocketsim_env,
                      ...
                      log_to_wandb=True,
                      wandb_run_name="bot6 init", # Name of your Weights And Biases run.
