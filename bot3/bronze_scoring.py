...
def build_rocketsim_env():
    ...
    reward_fn = CombinedReward.from_zipped(
        ...
        # (EventReward(touch=1), 10), # Start farming the ball touch
        # (SpeedTowardBallReward(), 2), # Move towards the ball!
        # (FaceBallReward(), 1), # Make sure we don't start driving backward at the ball
        # (InAirReward(), 0.000001), # Make sure we don't forget how to jump
        # (VelocityBallToGoalReward(), 0.00)
